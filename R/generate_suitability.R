...
generate_suitability <- function(env_rasters, niche, output_type = "binary") {
  ...
  # --- 2. Data Preparation ---
  message("ℹ️ Converting rasters to data frame...")
  ...
  message("ℹ️ Calculating suitability for ", format(nrow(points_to_classify), big.mark = ","), " pixels...")
  ...
  message("ℹ️ Reconstructing suitability raster...")
